...
public class SlidingTimeWindows {
  ...
  public static void main(String[] args) {
    ...
    pipeline
        ...
        // Sliding time windows を適用
        .apply("Apply windowing",
            Window.<KV<String, String>>into(SlidingWindows.of(Duration.standardMinutes(3L))
                .every(Duration.standardMinutes(1L))))
